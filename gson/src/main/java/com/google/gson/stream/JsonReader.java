...
public class JsonReader implements Closeable {
    ...
    {
        this.stack[this.stackSize++] = JsonScope.EMPTY_DOCUMENT;
    }
    ...
    public void beginArray() throws IOException {
        ...
        if (p == PEEKED_BEGIN_ARRAY) {
            ...
            throw new IllegalStateException("Expected BEGIN_ARRAY but was " + this.peek()
                    + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath());
        }
    }
    ...
    public void endArray() throws IOException {
        ...
        if (p == PEEKED_END_ARRAY) {
            ...
            throw new IllegalStateException("Expected END_ARRAY but was " + this.peek()
                    + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath());
        }
    }
    ...
    public void beginObject() throws IOException {
        ...
        if (p == PEEKED_BEGIN_OBJECT) {
            ...
            throw new IllegalStateException("Expected BEGIN_OBJECT but was " + this.peek()
                    + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath());
        }
    }
    ...
    private int doPeek() throws IOException {
        ...
        if (this.stackSize == 1) {
            this.checkLenient(); // Top-level value isn't an array or an object.
        }
    ...
    public double nextDouble() throws IOException {
        ...
        final double result = Double.parseDouble(this.peekedString); // don't catch this NumberFormatException.
    ...
    public long nextLong() throws IOException {
        ...
        this.peeked = PEEKED_BUFFERED;
        final double asDouble = Double.parseDouble(this.peekedString); // don't catch this NumberFormatException.
        final long result = (long) asDouble;
        if (result != asDouble) { // Make sure no precision was lost casting to 'long'.
            throw new NumberFormatException("Expected a long but was " + this.peekedString
                    + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath());
        }
        this.peekedString = null;
        this.peeked = PEEKED_NONE;
    ...
    public int nextInt() throws IOException {
        ...
        if (p == PEEKED_LONG) {
            ...
            if (this.peekedLong != result) { // Make sure no precision was lost casting to 'int'.
        ...
        if (result != asDouble) { // Make sure no precision was lost casting to 'int'.
            throw new NumberFormatException("Expected an int but was " + this.peekedString
                    + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath());
        }
        this.peekedString = null;
        this.peeked = PEEKED_NONE;

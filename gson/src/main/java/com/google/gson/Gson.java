...
public final class Gson {
    ...
    final JsonDeserializationContext                                   deserializationContext      = new JsonDeserializationContext() {
                                                                                                       ...
                                                                                                       public <T> T deserialize(final JsonElement json,
                                                                                                               final Type typeOfT)
    ...
    Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy,
            final Map<Type, InstanceCreator<?>> instanceCreators, final boolean serializeNulls,
            final boolean complexMapKeySerialization, final boolean generateNonExecutableGson, final boolean htmlSafe,
            final boolean prettyPrinting, final boolean serializeSpecialFloatingPointValues,
            final LongSerializationPolicy longSerializationPolicy,
            final List<TypeAdapterFactory> typeAdapterFactories) {
        ...
        factories.add(TypeAdapters.newFactory(long.class, Long.class,
                this.longAdapter(longSerializationPolicy)));
        factories.add(TypeAdapters.newFactory(double.class, Double.class,
                this.doubleAdapter(serializeSpecialFloatingPointValues)));
        factories.add(TypeAdapters.newFactory(float.class, Float.class,
                this.floatAdapter(serializeSpecialFloatingPointValues)));
    ...
    public <T> T fromJson(final String json, final Type typeOfT) throws JsonSyntaxException {
        ...
        final T target = (T) this.fromJson(reader, typeOfT);
        return target;
    }
    ...
    public <T> T fromJson(final Reader json, final Type typeOfT) throws JsonIOException, JsonSyntaxException {
        final JsonReader jsonReader = new JsonReader(json);
        final T object = (T) this.fromJson(jsonReader, typeOfT);
        assertFullConsumption(object, jsonReader);
        return object;
    }
    ...
    public <T> T fromJson(final JsonElement json, final Type typeOfT) throws JsonSyntaxException {
        ...
        return (T) this.fromJson(new JsonTreeReader(json), typeOfT);
    }
    ...
    public String toString() {
        return new StringBuilder("{serializeNulls:")
                .append(this.serializeNulls)
                .append("factories:").append(this.factories)
                .append(",instanceCreators:").append(this.constructorConstructor)
                .append("}")
                .toString();
    }
}

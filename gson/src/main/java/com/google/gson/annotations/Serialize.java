/*
 * Copyright (C) 2015 Markus Pfeiffer.
 * 
...
/**
 * An annotation that defines additional conditions to apply when serializing a member.
 * <p>
...
public @interface Serialize {
    ...
    public static enum Inclusion {
         ...
         *
         * <p>The value is included unless it is {@code null} or {@link com.google.gson.Gson} has
         * been built with a {@link com.google.gson.GsonBuilder} and the
         * {@link com.google.gson.GsonBuilder#serializeNulls()} method has been invoked.</p>
         */
        DEFAULT,
         ...
         *
         * <p>Note that this matches the default behavior unless {@link com.google.gson.Gson} has
         * been built with a {@link com.google.gson.GsonBuilder} and the
         * {@link com.google.gson.GsonBuilder#serializeNulls()} method has been invoked.</p>
         */
        NON_NULL,
         ...
         *
         * <p>Note that this has no effect if {@link com.google.gson.Gson} has been built with a
         * {@link com.google.gson.GsonBuilder} and the
         * {@link com.google.gson.GsonBuilder#serializeNulls()} method has been invoked.</p>
         */
        ALWAYS

...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public MapTypeAdapterFactory(final ConstructorConstructor constructorConstructor,
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        final// we don't define a type parameter for the key or value types
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Adapter(final Gson context, final Type keyType, final TypeAdapter<K> keyTypeAdapter,
                final Type valueType, final TypeAdapter<V> valueTypeAdapter,
        ...
        public Map<K, V> read(final JsonReader in) throws IOException {
            ...
            final Map<K, V> map = this.constructor.construct();
        ...
        public void write(final JsonWriter out, final Map<K, V> map) throws IOException {
            ...
            for (final Map.Entry<K, V> entry : map.entrySet()) {
                final JsonElement keyElement = this.keyTypeAdapter.toJsonTree(entry.getKey());
                keys.add(keyElement);

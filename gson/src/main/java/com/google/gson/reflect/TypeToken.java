...
public class TypeToken<T> {
    ...
    public boolean isAssignableFrom(final Type from) {
        ...
        if (this.type instanceof Class<?>) {
            ...
            return isAssignableFrom(from, (ParameterizedType) this.type,
            ...
            throw buildUnexpectedTypeError(
                    this.type, Class.class, ParameterizedType.class, GenericArrayType.class);
        }
    }
     ...
     */
    private static boolean typeEquals(final ParameterizedType from,
            final ParameterizedType to, final Map<String, Type> typeVarMap) {
    ...
    private static AssertionError buildUnexpectedTypeError(
            final Type token, final Class<?>... expected) {
